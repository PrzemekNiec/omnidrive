...
- [x] **Step 1: Zapisz baseline pliku**
...
- [x] **Step 5: Napisz skrypt weryfikacji ciał funkcji**
...
- [x] **Step 6: Uruchom bramkę i zacommituj rename**
...
- [x] **Step 3: Podłącz moduły w `mod.rs`**
...
- [x] **Step 1: Utwórz `vault_state.rs`**
...
- [x] **Step 2: Utwórz `system_config.rs`**
...
- [x] **Step 4: Utwórz `migration_v2.rs`**
...
- [x] **Step 5: Podłącz moduły i uruchom bramkę fali**
...
- [x] **Step 4: Utwórz `sync_policies.rs`**
...
- [x] **Step 7: Utwórz `metadata_backup.rs`**
...
- [x] **Step 8: Podłącz moduły i uruchom bramkę fali**
...
- [x] **Step 4: Podłącz moduły i uruchom bramkę fali**
...
- [x] **Step 3: Podłącz moduły i uruchom bramkę fali**
...
- [x] **Step 3: Utwórz `device_identity.rs`**
...
- [x] **Step 7: Utwórz `recovery_keys.rs`**
...
- [x] **Step 11: Podłącz moduły i uruchom bramkę fali**
...
- [x] **Step 1: Wypisz inwentarz testów**
...
- [x] **Step 2: Utwórz `test_support.rs`**
...
- [x] **Step 3: Rozdziel testy per domena**
...
- [x] **Step 5: Weryfikacja kompletności testów**
...
- [x] **Step 5: Weryfikacja zero-drift i zakresu**
...
- [x] **Step 1: Wpis P2-007 w `KNOWN_ISSUES.md`**
