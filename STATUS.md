...
│       ├── α.B.b.2   pure crypto: encaps/decaps + combiner + hybrid wrap/unwrap  ◄── NEXT
│       └── α.B.b.3   integracja + e2e: hybrid wrap → 2× decrypt → ten sam VK
│
