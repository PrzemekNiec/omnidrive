...
│   ├── α.A.c  Zeroize newtype KeyBytes (P2-005) ... 🔜 NEXT  ◄── JESTEŚMY TU
...
│   └── α.A.c — P2-005 Zeroize newtype dla KeyBytes  ◄── NEXT
│
