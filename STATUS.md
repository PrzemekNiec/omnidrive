...
└── γ.d — Snapshot upload guard        ✅ DONE — spec-premisa moot (append-only + advance-on-success); domknięte: restore-fallback, lokalny .bak/24h, sanity guard latest + 3 bugi z review (relative-path .bak, złe hasło→"brak kopii", S3 listing brał 32 NAJSTARSZE); ⏳ smoke G2 pending
```
