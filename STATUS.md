...
│   └── α.B.b — ML-KEM-768 hybrid wrap (NIST FIPS 203)  ◄── IN PROGRESS
...
│       └── α.B.b.3   integracja + e2e: hybrid wrap → 2× decrypt → ten sam VK  ◄── NEXT (plan TDD gotowy 3a4773b)
│
