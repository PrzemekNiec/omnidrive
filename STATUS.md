...
**Pozostały dług z audytu §2:** `downloader.rs` 1 712 (§2.4, split częściowy: dekrypcja V1/V2, prefetcher, pack cache) · `onboarding.rs` 1 293 · `api/onboarding.rs` 1 153 · `disaster_recovery.rs` 1 126 · `uploader.rs` 1 084 · `api/vault.rs` 1 078.
